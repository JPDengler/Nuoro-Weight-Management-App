...
The enhancements implemented in this project were guided by the requirements of **CS-499: Computer Science Capstone**, aligning with software design and engineering outcomes. Below are the detailed justifications and implementations:
...
Include key screenshots here or reference their location in the repository (e.g., `/screenshots` folder).
